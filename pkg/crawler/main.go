...
// GetBMCServiceRoot connects to a BMC (Baseboard Management Controller) using the provided configuration,
// and retrieves the ServiceRoot.
//
// Parameters:
//   - config: A CrawlerConfig struct containing the URI, username, password, and other connection details.
//
// Returns:
//   - *gofish.Service: The ServiceRoot struct retrieved from the BMC.

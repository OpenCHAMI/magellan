...
*pdu* _host_,... [-u _username_] [-p _password]
	...
	*-p, --password* _value_
		Set the password to _value_ used for basic authentication to the PDU node.

	*-u, --username* _value_
		Set the username to _value_ used for basic authentication to the PDU node.
